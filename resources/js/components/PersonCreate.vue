<template>
  <layout-div>
    <h2 class="text-center mt-5 mb-3">Inserisci una nuova persona</h2>
    <div class="card">
        ...
        <form>
          ...
          <div class="form-group">
            ...
            <b-form-datepicker id="example-datepicker" class="form-control mb-2" v-model="person.birth_date" locale="it"
              ...
              :date-format-options="{ year: 'numeric', month: 'numeric', day: 'numeric' }" :min="minDate" :max="maxDate"
              :state="datePickerState" @shown="validationErrors.birth_date = null">
            </b-form-datepicker>
          ...
          <div class="form-group">
            ...
            <select class="form-select" v-model="person.gender" @focus="validationErrors.gender = null"
...
export default {
  ...
  methods: {
    handleSave() {
      ...
      this.isSaving = true
      axios.post(`/api/people`, this.person)
        .then(response => {
          Swal.fire({
            icon: 'success',
